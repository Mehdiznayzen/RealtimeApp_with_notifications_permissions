...
const Notifications = () => {
    ...
    const unreadNtifocations = inboxNotifications.filter((notification) => !notification.readAt)
            ...
            <PopoverContent align="end" className="shad-popover">
                ...
                >
                    <InboxNotificationList>
                        {
                            unreadNtifocations.length <= 0 && (
                                <p className="py-2 text-center text-dark-500">No new notifocations</p>
                            )
                        }

                        {
                            unreadNtifocations.length > 0 && unreadNtifocations.map((notification) => (
                                <InboxNotification
                                    key={notification.id}
